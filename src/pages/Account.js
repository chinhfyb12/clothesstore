...
const useStyles = makeStyles((theme) => ({
    ...
    cart: {
        display: 'flex',
        justifyContent: 'center',
        boxShadow: '0 2.8px 2.2px rgba(0, 0, 0, 0.014), 0 6.7px 5.3px rgba(0, 0, 0, 0.02), 0 12.5px 10px rgba(0, 0, 0, 0.025), 0 22.3px 17.9px rgba(0, 0, 0, 0.03), 0 41.8px 33.4px rgba(0, 0, 0, 0.036), 0 100px 80px rgba(0, 0, 0, 0.05)',
        padding: '2rem',
        marginLeft: 'auto',
        marginRight: 'auto',
        width: 'max-content',
        height: 300,
        backgroundColor: '#f6fcff8f',
        borderRadius: 15,
        marginTop: '2rem',
    },
    cartContent: {
